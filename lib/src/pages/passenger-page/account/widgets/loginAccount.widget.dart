...
class _LoginAccountState extends State<LoginAccount> {
  ...
  void _functionLoginWithEmailPass(BuildContext context) {
    if (_formKey.currentState.validate()) {
      ...
      _auth
        ...
        PassengerPagesNavigation.goToHome(context);
      }, onError: (ex) {
        new Future.delayed(new Duration(seconds: 1), () {
          widget._baseBloc.loadingStatusEvent.add(false);
        });
        ...
        switch (ex.code) {
          ...
          case "ERROR_INVALID_EMAIL":
            ShowSnackBar.build(
                widget._scaffoldLoginKey, 'Invalid E-mail !', context);
            break;
          default:
            ShowSnackBar.build(widget._scaffoldLoginKey,
  ...
  void _functionLoginWithGoogle(BuildContext context) {
    ...
    _auth.signWithGoogle().then((r) {
      ...
      switch (ex.code) {
        case "ERROR_WRONG_PASSWORD":
          ShowSnackBar.build(
              widget._scaffoldLoginKey, 'User or Password incorrect!', context);
          break;
        case "ERROR_INVALID_EMAIL":
          ShowSnackBar.build(
  ...
  Widget _buildForgot() => Padding(
        ...
        child: FlatButton(
            onPressed: () => PassengerPagesNavigation.goToRecoveryPass(context),
            child: Text(
              "Forgot password?",
              style: TextStyle(
              ...
              children: <Widget>[
                _buildFacebookGoogleButton(
                  ...
                  ShowSnackBar.build(
                      ...
                      'Currently it is only possible to login with Google account or with E-mail!',
                      context);
                  return false;
