...
class TripStartedWidget extends StatefulWidget {
  @override
  _TripStartedWidgetState createState() => _TripStartedWidgetState();
}

class _TripStartedWidgetState extends State<TripStartedWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    _timeLookingForDriver = Timer.periodic(Duration(seconds: 1), (Timer t) {
      ...
      print('Time  radar trip started $i');
