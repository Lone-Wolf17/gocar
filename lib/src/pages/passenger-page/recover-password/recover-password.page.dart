...
class PassengerRecoverPasswordPage extends StatefulWidget {
  PassengerRecoverPasswordPage({Key key}) : super(key: key);

  @override
  _PassengerRecoverPasswordPageState createState() =>
      _PassengerRecoverPasswordPageState();
}

class _PassengerRecoverPasswordPageState
    extends State<PassengerRecoverPasswordPage> {
