...
class DriverRecoverPasswordPage extends StatefulWidget {
  DriverRecoverPasswordPage({Key key}) : super(key: key);

  @override
  _DriverRecoverPasswordPageState createState() =>
      _DriverRecoverPasswordPageState();
}

class _DriverRecoverPasswordPageState extends State<DriverRecoverPasswordPage> {
